...
@section('title')
    Hieu chinh phuong thuc thanh toan
@endsection
...
<h2>Hiệu chỉnh phương thức thanh toán</h2>
<form method="post" action="{{ route('danhsachthanhtoan.update', ['id' => $tt->tt_ma]) }}" enctype="multipart/form-data">
